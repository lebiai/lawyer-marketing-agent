...
### 📊 竞品账号分析
基于 blogger-distiller 数据分析引擎，通过 TikHub API 采集公开数据进行深度分析。
分析结果覆盖 7 大维度：定位基调、语言文字、内容策略、互动表现、高频话题、高互动内容、认知层。
分析完成后自动将风格特征入库，后续文案创作可直接调用。

> 🔒 竞品分析需要开通权限，请联系微信 iodun001 开通
